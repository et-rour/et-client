<template>
  <div>
    ...
    <!-- {{ user }} -->
    <!-- {{ currentUser }} -->
    <form class="w-full grid grid-cols-12 gap-2 mt-9">
      ...
      <div class="col-span-12">
        <input type="checkbox" v-model="currentUser.isOwner" />
        <label for="name" class="ml-2">{{
          $t("profile.profile.isOwner")
        }}</label>
      </div>
      ...
      <div class="col-span-12 flex justify-end">
        <button class="my-btn" @click.prevent="updateUserHandler">
